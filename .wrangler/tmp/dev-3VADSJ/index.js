...
// src/auth/jwt.js
async function createJWT(payload, secret, expSeconds = 86400) {
  return sign2(
    {
      ...payload,
      exp: Math.floor(Date.now() / 1e3) + expSeconds
    },
    secret
  );
}
...
// .wrangler/tmp/bundle-ijQRK9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ijQRK9/middleware-loader.entry.ts
